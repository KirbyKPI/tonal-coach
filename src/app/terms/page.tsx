...
export const metadata: Metadata = {
  ...
  description: "Terms of service for KPI·FIT Tonal Coach.",
    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p>
            By creating an account or using KPI·FIT Tonal Coach, you agree to these terms and our{" "}
        ...
        <section>
          ...
          <p>
            KPI·FIT Tonal Coach is an independent, experimental project that provides AI-powered coaching
        ...
        <section>
          ...
          <ul className="list-inside list-disc space-y-1">
            ...
            <li>You are responsible for the security of your KPI·FIT Tonal Coach account</li>
            <li>
