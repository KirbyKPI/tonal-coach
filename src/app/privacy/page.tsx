...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for KPI·FIT Tonal Coach. Learn how we handle your data, Tonal credentials, and account information.",
    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p>
            KPI·FIT Tonal Coach is an independent project built by an individual developer. It is not
        ...
        <section>
          ...
          <ul className="list-inside list-disc space-y-1">
            <li>Your KPI·FIT Tonal Coach account (email, hashed password)</li>
        ...
        <section>
          ...
          <p>
            You can disconnect your Tonal account and delete your KPI·FIT Tonal Coach account at any time.
        ...
        <section>
          ...
          <p>
            ...
            account, though no such issues have been reported. By using KPI·FIT Tonal Coach, you acknowledge
